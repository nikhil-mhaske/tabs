...
/* harmony import */ var _tab_tab_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tab/tab.js */ "./src/tab/tab.js");
...
function Edit(props) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.useBlockProps)(), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.InnerBlocks, {
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Tabs Settings", "tabs")
...
(0,_wordpress_blocks__WEBPACK_IMPORTED_MODULE_4__.registerBlockType)("create-block/tab", {
  title: "Tab",
  ...
  edit: props => {
    ...
    const dashicons = ["plus", "admin-site", "admin-post", "admin-media", "admin-links", "admin-page", "admin-comments", "admin-plugins", "admin-users", "admin-tools", "admin-settings", "format-image", "format-gallery", "format-video", "format-audio", "format-quote", "format-chat", "category", "tag", "admin-home", "welcome-learn-more", "welcome-view-site", "welcome-widgets-menus", "welcome-write-blog"];
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: "icons"
    }, dashicons.map(icon => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
      className: `dashicons dashicons-${icon} tab-icon ${icon === tabIcon ? "selected" : ""}`,
